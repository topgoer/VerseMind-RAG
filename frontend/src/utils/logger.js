...
console.log('VITE_LOG_LEVEL from import.meta.env:', import.meta.env.VITE_LOG_LEVEL);

// Debug logs are commented out to reduce console noise
...
class Logger {
  constructor(module) {
    ...
    // Debug initialization log is commented out to reduce console noise
